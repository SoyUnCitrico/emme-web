  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-matrix-green to-neon-orange p-1 shadow-glow-green">
            <AsciiImage src="/images/emme.jpg" alt="Desarrollador" />
          </div>

          {/* Elementos decorativos */}
          <motion.div
            className="absolute -bottom-6 -right-6 w-24 h-24 bg-matrix-green/20 rounded-full z-[-1]"
            animate={{ 
              scale: [1, 1.1, 1],
              rotate: [0, 5, 0] 
            }}
          ...
          />
          <motion.div
            className="absolute -top-6 -left-6 w-16 h-16 bg-neon-orange/20 rounded-full z-[-1]"
            animate={{ 
              scale: [1, 1.2, 1],
              rotate: [0, -5, 0] 
            }}
        ...
        >
          <h3 className="text-2xl md:text-3xl font-bold text-matrix-green mb-4 text-glow-green">
            ¡Hola! Soy <span className="text-neon-orange">Emmanuel Arenas</span>
          </h3>
          ...
          <div className="flex flex-wrap gap-4 my-6">
            <div className="flex items-center">
              <div className="w-12 h-12 bg-matrix-panel border border-matrix-line rounded-full flex items-center justify-center mr-3">
              ...
              <div>
                <h4 className="font-medium text-matrix-green">+4 años</h4>
                <p className="text-sm text-matrix-dim">Experiencia</p>
              </div>
            </div>

            <div className="flex items-center">
              <div className="w-12 h-12 bg-matrix-panel border border-matrix-line rounded-full flex items-center justify-center mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-neon-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
              </div>
              <div>
                <h4 className="font-medium text-neon-orange">+20 proyectos</h4>
                <p className="text-sm text-matrix-dim">Completados</p>
              </div>
            </div>
          </div>
